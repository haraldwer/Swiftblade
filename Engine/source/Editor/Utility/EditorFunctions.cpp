...
bool Editor::EditHierarchy(const ECS::EntityID InRootID, ECS::EntityID& InOutSelected, bool InRecursive)
{
    bool result = false; 
...
bool Editor::EditScene(ECS::EntityID& InOutSelected)
{
    bool result = false;
...
bool Editor::EditComponents(const ECS::EntityID InID)
{
