...
bool Music::ToneLibrary::Edit(const String &InName, uint32 InOffset)
{
    bool edited = false;
...
bool Music::ToneLibrary::Contains(const String &InName)
{
...
Music::Tone& Music::ToneLibrary::Get(const String &InName)
{
...
void Music::ToneLibrary::UpdateCache()
{
    toneCache.clear();
