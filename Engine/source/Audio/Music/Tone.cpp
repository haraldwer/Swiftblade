...
float Music::Tone::Evaluate(const ToneTiming& InTiming, const uint64 InFrame) const
{
...
bool Music::Tone::Edit(const String &InName, uint32 InOffset)
{
...
void Music::Tone::Plot(const String& InOverlay)
{
...
bool Music::Tone::Edit() { return false; }
void Music::Tone::Plot(const String &InOverlay) {  }

#endif

void Music::Tone::UpdateTonePreview(const ToneTiming &InTiming)
{
...
void Music::Tone::UpdatePreview(const Expression& InExpr, const ToneTiming& InTiming, Vector<float>& InPreview)
{
...
float Music::Tone::Evaluate(const Expression& InFunc, const ToneTiming& InTiming, const uint64 InFrame)
{
...
void Music::Tone::Declare(Expression& InFunc)
{
